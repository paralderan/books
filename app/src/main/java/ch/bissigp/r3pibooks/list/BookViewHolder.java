...
import ch.bissigp.r3pibooks.BookDetailActivity;
...
public class BookViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void setVolume(Volume vol) {
        ...
        ImageView cover = itemView.findViewById(R.id.item_cover);
        ...
        if (volumeInfo.getTitle() != null) {
            ((TextView) itemView.findViewById(R.id.item_title)).setText(volumeInfo.getTitle());
        }
    ...
    public void onClick(View v) {
        ...
        context.startActivity(new Intent(context, BookDetailActivity.class).putExtra("metadata", metadata));
    }
}
